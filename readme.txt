...
javac -cp .:ijatool.jar:junit-platform-console-standalone-1.11.4.jar -d build ija2024-ukol2/ija/ija2024/homework2/Homework2Test.java
# Spusteni testu s vyuzitim JUnit:
java -ea -jar ./${JUNIT} execute --cp build:ijatool.jar --scan-class-path
java -ea -jar ./junit-platform-console-standalone-1.11.4.jar execute --cp build:ijatool.jar --scan-class-path
